...
def startPredicting(imgPathe):
	...
	os.system("rd /s /q " + locationSlices) #cleanup= delete the thousands of slices
...
def upload(lsbox,uploadPathEntry,uploadNameEntry):
	...
	copycommand = 'copy "' + newupet + '" "'  + newDir + '\"'
	...
	movecommand = 'move "' + beforePathName + '" "' + afterPathName + '.jpg"'
